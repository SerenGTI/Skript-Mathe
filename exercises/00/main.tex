...
\begin{lsg}{}
	...
	\begin{enumerate}
		...
		\begin{align*}
		\text{Damit gilt: }\ t(x)&=4*(x-1)+3 = 4x-1 \\
		\text{und: }\ n(x)&=-\frac{1}{4}*(x-1)+3=-\frac{1}{4}x-\frac{11}4
		\end{align*}
		\item \begin{align*}
			...
			\end{align*}
			\item Aus dem Punkt $Q(3|17)$ folgt: $\ t(3)=17$, daher gilt für die Tangentengleichungen:\begin{align*}
