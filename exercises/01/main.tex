...
\begin{inhalt}
	...
	\item Exponentialfunktion \seite{33}
...
\begin{enumerate}
	\item Führe eine vollständige Graphanalyse von $f$ durch. (Dazu gehören Nullstellen, Wendepunkte, Extrempunkte, Monotonie, Verhalten für $\pm \infty$, Definitionsbreich und Wertemenge bzw Definitonslücken)
	\item
\end{enumerate}
