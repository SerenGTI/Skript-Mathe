...
\begin{document}
\begin{inhalt}
	\item Wachstum\seite{47}
	\item LGS-Rechnung \seite{53}, Vektorrechnung \seite{63}
	\item Geraden und Ebenen \seite{67}
\end{inhalt}
...
\begin{enumerate}
	...
	\end{equation*}
	Gib die Ebene $G$ in Koordinatenform an. %Parameterform -> Koordinatenform
...
Gib einen Vektor an, der senkrecht zu den beiden angegebenen Vektoren ist. Berechne außerdem den Flächeninhalt des durch die gegebenen Vektoren aufgespannten Parallelogramms.
\begin{enumerate}
